c $Header: /data/petsun4/data1/src_solaris/librms/RCS/param6opr.f,v 1.2 2007/04/17 05:34:45 avi Exp $
c $Log: param6opr.f,v $
...
c     Avi Snyder 22-Oct-93
      ...
      character*256 rcsid /'$Id: param6opr.f,v 1.2 2007/04/17 05:34:45 avi Exp $'/
