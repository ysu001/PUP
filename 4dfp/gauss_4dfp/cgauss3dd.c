/*$Header: /data/petsun4/data1/src_solaris/gauss_4dfp/RCS/cgauss3dd.c,v 1.2 2007/05/04 01:57:59 avi Exp $*/
/*$Log: cgauss3dd.c,v $
...
/****************************************************************************************/
	...
	n2 = n1 + 1;
	n2ny = n2*ny;
	if (!(a = (float *) malloc (n2*ny*nz * sizeof (float)))) errm ("gauss3dd");
	if (!(b = (float *) malloc (n2*ny*nz * sizeof (float)))) errm ("gauss3dd");
