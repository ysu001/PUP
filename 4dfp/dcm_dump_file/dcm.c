/*$Header: /data/petsun4/data1/src_solaris/dcm_dump_file/RCS/dcm.c,v 1.3 2012/12/05 01:46:48 avi Exp $*/
/*$Log: dcm.c,v $
 * Revision 1.3  2012/12/05  01:46:48  avi
 * type casting to suppress compile warnings
 *
 * Revision 1.2  2008/07/24  06:49:05  avi
 * linux compatible resolution of prototypes for exit() and swab()
 *
 * Revision 1.1  2008/07/24  06:30:29  avi
 * Initial revision
 **/
/*
...
** Last Update:		$Author: avi $, $Date: 2012/12/05 01:46:48 $
...
extern void exit (int status);		/* instead if #include stdlib.h which has incompatible definition of swab */
static CONDITION
