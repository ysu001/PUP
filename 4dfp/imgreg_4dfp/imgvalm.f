c$Id: imgvalm.f,v 1.1 1998/10/02 20:23:27 mcavoy Exp $
c$Log: imgvalm.f,v $
...
c     lslice= 0 coordinate not in mask
     ...
     &/'$Header: /data/petsun4/data1/src_solaris/imgreg_4dfp/RCS/imgvalm.f,v 1.1 1998/10/02 20:23:27 mcavoy Exp $'/
