c$Header: /data/petsun4/data1/src_solaris/imgreg_4dfp/RCS/fimgreg.f,v 1.20 2012/06/05 01:57:11 avi Exp $
c$Log: fimgreg.f,v $
c Revision 1.20  2012/06/05  01:57:11  avi
c in Hessian mode make goto 78 conditional also on cndnum>50 and set initial niter=5
c
...
c
      ...
      write(*,"('$Id: fimgreg.f,v 1.20 2012/06/05 01:57:11 avi Exp $')")
      return
      end
...
c     finds optimal translation/rotation to achieve registration of img2 on img1
  ...
  102 format(6f10.4)
   ...
   77 param(j)=param(j)-h*garam(i)*qaram(j)*rscale
     ...
     &             img2,msk2,nx2,ny2,nz2,mmppix2,center2,param,mode,del,eta,q)
      write(*,"('eta,q',f8.5,f9.5)")eta,q
      if(eta.lt.0.95*etamax.and.cndnum>50.)then
        lrestart=.true.
        goto 78
      endif
