c$Header: /data/petsun4/data1/src_solaris/t4imgs_4dfp/RCS/ft4imgo.f,v 1.3 2007/04/29 05:13:28 avi Exp $
c$Log: ft4imgo.f,v $
...
c
    ...
    1 continue
      ...
      character*256 rcsid/'$Id: ft4imgo.f,v 1.3 2007/04/29 05:13:28 avi Exp $'/
