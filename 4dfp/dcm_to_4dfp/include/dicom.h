...
**			standard.
** Last Update:		$Author: karchie $, $Date: 2006/08/31 17:34:39 $
...
#else
#error DICOM library requires sizeof(short) = 2, not SIZEOF_SHORT.  Sorry.
#endif
    ...
    typedef long S32;
#else
#error DICOM library requires, but could not find, a 32 bit integer type.  Sorry.
#endif
