/*$Header: /data/petsun4/data1/src_solaris/zero_lt_4dfp/RCS/zero_ltgt_4dfp.c,v 1.4 2007/08/19 00:27:19 avi Exp $*/
 ...
 *
 * Revision 1.2  2002/04/06  01:08:04  avi
 * correct operation message in rec file
 *
 * Revision 1.1  2002/04/06  00:58:43  avi
 * Initial revision
 **/
...
static char rcsid[]= "$Id: zero_ltgt_4dfp.c,v 1.4 2007/08/19 00:27:19 avi Exp $";
...
/************************/
	...
	if (k < 2) {
		...
		printf ("N.B.:\t%s zeroes voxel values outside the specified range\n", program);
...
/*******************/
	...
	sprintf (command, "Zeroed outside range %.4f to %.4f\n", tlo, thi); printrec (command);
	catrec  (imgfile);
        endrec  ();
